...
public class Constants {
	...
	public static final String SMALL_BUILDING 	= "*";
	public static final String MEDIUM_BUILDING 	= "%";
	public static final String BIG_BUILDING 	= "&";
	...
	public static boolean isCharMovementAction(char value) {
		...
		return value == FORWARD_MOVE || value == BACK_MOVE
			|| value == LEFT_MOVE || value == RIGHT_MOVE;
	}
